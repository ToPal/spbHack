<?php
    ...
    function getCumulativeRaiting($location) {
        ...
        $localRaitings = array();
        $localRaitings['socialRaiting'] = getLocalRaiting($raitings, $coeffs, array(Pharmacies_id, Kindergartens_id));
        $localRaitings['infrastructureRaiting'] = getLocalRaiting($raitings, $coeffs, array(Metro_id));
        $localRaitings['recreationRaiting'] = getLocalRaiting($raitings, $coeffs, array(Parks_id, Cinema_id, Sport_id));
